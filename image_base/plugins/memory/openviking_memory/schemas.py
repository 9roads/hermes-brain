"""Model-facing tool schemas for the OpenViking memory provider."""
...
SEARCH_SCHEMA: dict[str, Any] = {
    ...
    "description": (
        ...
        "Returns ranked viking:// URIs for deeper reading across user memory, "
        "agent memory, and resources."
    ),
    "parameters": {
        "type": "object",
        "properties": {
...
READ_SCHEMA: dict[str, Any] = {
    ...
    "description": (
        "Read content at a viking:// user, agent, or resources URI. "
...
LIST_SCHEMA: dict[str, Any] = {
    ...
    "parameters": {
        ...
        "properties": {
            "uri": {
                "type": "string",
                "description": "Public viking:// directory URI to browse, or viking:// for the root.",
            },
            "recursive": {
                "type": "boolean",
...
GREP_SCHEMA: dict[str, Any] = {
    ...
    "description": (
        "Exact text or regex search across viking:// memory and resource files. "
    ...
    "parameters": {
        ...
        "properties": {
            "uri": {
                "type": "string",
                "description": "Public viking:// scope to search, or viking:// for all public scopes.",
            },
            "pattern": {
                "type": "string",
            ...
            "exclude_uri": {
                "type": "string",
                "description": "Optional public viking:// URI prefix to exclude from search.",
            },
            "limit": {
                "type": "integer",
                "minimum": 1,
...
def tool_schemas(enabled: set[str]) -> list[dict[str, Any]]:
    ...
    if "search" in enabled:
        schemas.append(SEARCH_SCHEMA)
    if "read" in enabled:
        schemas.append(READ_SCHEMA)
    if "list" in enabled:
        schemas.append(LIST_SCHEMA)
    if "grep" in enabled:
        schemas.append(GREP_SCHEMA)
    if "add_resource" in enabled:
        schemas.append(ADD_RESOURCE_SCHEMA)
    if "capture" in enabled:
        schemas.append(CAPTURE_SCHEMA)
    return schemas
