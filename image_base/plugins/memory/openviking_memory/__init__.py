...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def _tool_read(self, args: Dict[str, Any]) -> str:
        ...
        self._config.validate_viking_uris([self._normalize_summary_uri(uri)])
    ...
    def _tool_list(self, args: Dict[str, Any]) -> str:
        ...
        if not uri:
            return tool_error("uri is required")
        uri = self._config.validate_viking_uris([uri], allow_root=True)[0]
    ...
    def _tool_grep(self, args: Dict[str, Any]) -> str:
        ...
        if args.get("exclude_uri"):
            payload["exclude_uri"] = self._config.validate_viking_uris(
