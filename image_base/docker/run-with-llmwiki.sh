...
export LLMWIKI_MODEL="${LLMWIKI_MODEL:-deepseek-v4-pro}"
export LLMWIKI_EXTRACT_MODEL="${LLMWIKI_EXTRACT_MODEL:-deepseek-v4-flash}"
export LLMWIKI_EXTRACT_CONCURRENCY="${LLMWIKI_EXTRACT_CONCURRENCY:-10}"
