...
BUILD_KWARGS_PATCH_MARKER = "__phoenix_openai_text_verbosity_build_kwargs_patched__"
PREFLIGHT_PATCH_MARKER = "__phoenix_openai_text_verbosity_preflight_patched__"
...
def patch_responses_transport() -> bool:
    ...
    if not hasattr(transport, "_phoenix_original_build_kwargs"):
        transport._phoenix_original_build_kwargs = original_build_kwargs
...
def patch_codex_preflight() -> bool:
    ...
    if not hasattr(adapter_module, "_phoenix_original_preflight_codex_api_kwargs"):
        adapter_module._phoenix_original_preflight_codex_api_kwargs = original_preflight
