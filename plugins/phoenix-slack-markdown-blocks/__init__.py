...
def patch_slack_adapter() -> bool:
    ...
    if not hasattr(slack_adapter, "_phoenix_original_send"):
        slack_adapter._phoenix_original_send = original_send
    if not hasattr(slack_adapter, "_phoenix_original_edit_message"):
        slack_adapter._phoenix_original_edit_message = original_edit_message
...
def patch_send_message_tool() -> bool:
    ...
    if not hasattr(send_message_tool, "_phoenix_original_send_to_platform"):
        send_message_tool._phoenix_original_send_to_platform = original_send_to_platform
    if not hasattr(send_message_tool, "_phoenix_original_send_slack"):
        send_message_tool._phoenix_original_send_slack = getattr(
            send_message_tool,
            "_send_slack",
            None,
        )
