...
SET_SLACK_HOME_CHANNEL_SCHEMA = {
    ...
    "description": (
        "Persist and immediately apply the Slack channel/chat ID where Phoenix Hermes "
...
def register(ctx: Any) -> None:
    def pre_gateway_dispatch(*args: Any, **kwargs: Any) -> None:
        ...
        try:
            ...
            LOGGER.warning("Phoenix Slack home selection failed; using current Slack source: %s", exc)
...
def choose_channel_with_llm(
    ...
    prompt = (
        "Choose the best Slack home channel for Phoenix Hermes proactive messages.\n"
        "Prefer channels about Phoenix, Hermes, agents, alerts, updates, ops, "
        "or the main general/team channel. Avoid narrow private channels unless "
        "their name or purpose clearly fits Phoenix agent output.\n"
