...
WEBHOOK = {
    "type": "object",
    "description": (
        "Hermes dynamic webhook route options for Loisa trigger subscriptions. "
...
LIST_TRIGGERS = {
    ...
    "description": (
        ...
        "Loisa workspace. Returns compact trigger summaries; call get_trigger_schema "
...
CREATE_TRIGGER = {
    "name": "create_trigger",
    "description": (
        "Create a Composio trigger instance through Loisa, then create the matching "
        "Hermes dynamic webhook route in the Loisa profile. Call get_trigger_schema "
        ...
        "properties": {
            ...
            "trigger_config": {
                ...
                "description": (
                    ...
                    "passed through to Loisa for validation and Composio creation."
                ),
            },
            "connected_account_id": {
                "type": "string",
                "description": (
                    "Optional Loisa/Composio connected account ID. Omit only when "
...
DELETE_TRIGGER = {
    "name": "delete_trigger",
    "description": (
        "Delete an active Loisa-managed Composio trigger, then remove its Hermes "
        "dynamic webhook route from the Loisa profile."
    ),
    "parameters": {
        "type": "object",
        "additionalProperties": False,
