...
PLUGIN_ID = "loisa-slack-thread-gate"
...
PATCH_MARKER = "__loisa_slack_thread_gate_patched__"
ORIGINAL_HANDLE_ATTR = "_loisa_slack_thread_gate_original_handle_message"
CONTEXT_ATTR = "_loisa_slack_thread_gate_context"
...
THREAD_GATE_INSTRUCTIONS = (
    "Decide whether the Slack assistant Loisa/Hermes should respond to "
    ...
    "appear connected to Loisa/Hermes. Return should_respond=false only "
